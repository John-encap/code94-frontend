...
const ToolBar = () => {
    ...
    <div className="flex gap-[30%] flex-row justify-between">
        ...
        <div className="flex flex-row gap-4">
            <Button onClick={handleAdd} className="text-white hover:bg-white hover:text-black hover:border hover:border-primary transition duration-200 bg-primary w-[150px] rounded-lg text-xs">
                New Product
            </Button>
